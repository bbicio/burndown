...
portfolio.html           — project reporting dashboard (portfolio overview + per-project dashboard), Vue 3 (CDN, no build step, same pattern as project-config.html). Full implementation narrative (js/portfolio.js + js/dashboard.js history, js/lib/portfolio-calc.js, list-view card restructure, filters, Summary by task/role/functional area, back-navigation): see [docs/pages/portfolio.md](docs/pages/portfolio.md).
