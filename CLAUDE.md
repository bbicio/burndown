...
| `team.html` | `/team.html` | Resource registry CRUD (name/email/job title/job description, optional link to a PDash user) plus, since 2026-09 (Cycle 3b), an "Unmatched names" panel that links the free-text owner names found in uploaded actuals to resources (aliases); admin **or sysadmin**, linked from the ⚙ Admin dropdown. Full narrative: [docs/pages/team.md](docs/pages/team.md) |
