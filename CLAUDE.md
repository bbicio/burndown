...
planning.html            — resource planning; removes the same dead #rolesModal/#roleModal Roles Registry markup confirmed dead on costgrid.html (only reachable opener lived in the unloaded js/main.js)
