...
| TS-17 | XLSX export replaces CSV | Click ⬇ XLSX for a project | An `.xlsx` file downloads (no `.csv` option exists), named `Client_Project_ProjectCode_YYYYMMDD.xlsx`, containing the same 8 columns as the View modal grid including Fee/Spent | |
